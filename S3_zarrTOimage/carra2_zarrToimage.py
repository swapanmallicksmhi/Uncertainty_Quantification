...
if __name__ == "__main__":
    ...
    for VARIABLE in VALID_VARIABLES:
        ...
        zarr_path = Path(f"{INPUT}/{YYYY}{MM}/{VARIABLE}/{VARIABLE}_CARRA2_{YYYY}{MM}.zarr")
        ...
        for i, time_val in enumerate(time_values):
            ...
            # Plot SD
            sd_filename = f"SD_{VARIABLE}_{time_str}_carra2.png"
            plot_data(
                ens_std[i, :, :],
            ...
            # Plot mean
            mean_filename = f"EnsMEAN_{VARIABLE}_{time_str}_carra2.png"
            plot_data(
                ens_mean[i, :, :],
