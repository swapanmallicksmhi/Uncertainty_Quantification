...
def process_dyn(PATH_TO_DATA, VARIABLE, YY, MM, DDN, HH):
    ...
    if "AAAA" not in VARIABLE:
        plot_dyn("Dyn", Dyn, "dyn_carra2.png", timestamp, levels)
        plot_dynC("Dyn", Dyn, "CROP_dyn_carra2.png", timestamp, levels)
...
SCRPDIR = "/home/swe4281/repository/CARRA_QC2025/Uncertainty_Quantification_git/S8_EVALATION_ERACARRA_DATA/CARRA2DYN_PLOTS"
    ...
    for HH in ['00', '06', '12', '18']:
        ...
        for param in params:
            ...
            try:
                ...
                OUTPUT = f"{OUTDIR}/PLOTS/{param}"
                os.makedirs(OUTPUT, exist_ok=True)

                for png1 in ['dyn', 'CROP_dyn']:
                    fname = f"{png1}_carra2.png"
